...
# ${CONFIG_FILE} \
# /home/thaddaus/WORK_DIRS/GPA/tuning/coco_piropo_100a_TwoStageDetectorAdaptive_10_01_100_01_fclayer_gTrue_seed_0/best_bbox_mAP_50_epoch_25.pth \
# ${N_GPU} \
# --format-only \
# --options "jsonfile_prefix=./results/analysis/gpa_10_01_100_01" \
# --cfg-options data.samples_per_gpu=$(($BATCH/$N_GPU)) \
#     data.val.ann_file=${TEST_FILE} \
#     data.val.img_prefix=None \
...
python mmdetection/tools/analysis_tools/coco_error_analysis.py \
    results/gpa_10_01_100_01.bbox.json \
    results/analysis \
    --ann=${TEST_FILE}
